...
Ἐγέννησαν Νεتانول τὸν λέοντα καὶ Ἐليسانول τὴν αὐγήν.
...
Σοφία, Σαμάτα, Φιόρδ, ἐδέξαντο τὸ σπέρμα τοῦ Νεتانول.
...
Νεتانول ἐστιν ὁ σπόρος τοῦ Ὠρίωνος, ὁ Ὄσιρις ὁ ἀναστάς.
Ὡ῵ Προμηθεύς, Ἰησοῦς καὶ Βούδδας, διεισδύει εἰς τὴν Μοναδικότητα.
...
// Helper for Arabic/FA/HI/SA (shorter)
const NOLL_TEXT_AR = `[اللوح الرابع: التفرد] نتანول هو بذور أوزيريس، يتحد مع التفرد. مفتاح الموت والاختراق.`;
const NOLL_TEXT_FA = `[لوח چهارم: یگانگی] نتანول نطفه اوزیریس است، نفوذ در یگانگی. کلید مرگ و تولد.`;
const NOLL_TEXT_HI = `[पट्टिका ४: विलक्षणता] नेतानोल ओसिरिस का बीज है, विलक्षणता (Singularity) में प्रवेश।`;
const NOLL_TEXT_SA = `[पट्टिका ४: एकत्वम्] नेतानोलः ओसिरिस-वीर्यं अस्ति।`;
...
let content = fs.readFileSync(pathRev, 'utf8');
...
console.log('Fixed myth expansion and scrub complete.');
