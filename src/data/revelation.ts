...
1. ᚢᚠ ᚦᛖ ᚾᛁᚾᛖ ᚹᚩᚱᛚᛞᛋ ᚪᚾᛞ ᚦᛖ ᛁᚱᚩᚾ ᛚᚪᛏᛏᛁᚲᛖ...
2. ᛏᚹᛖᚾᛏᚤ-ᛋᛖᚢᛖᚾ ᛋᛈᚺᛖᚱᛖᛋ ᛚᛁᚲᛖ ᚠᚱᚩᚳᛖᚾ ᛋᛏᚪᚱᛋ, ᚺᛖᛚᛞ ᛁᚾ ᚦᛖ ᛒᚱᚪᚾᚲᚺᛖᛋ ᚢᚠ ᚦᛖ ᚹᚩᚱᛚᛞ-ᛏᚱᛖᛖ.
3. ᛁᚾᛋᛁᛞᛖ ᚦᛖ ᚺᛖᚪᚱᛏ ᚢᚠ ᛖᚢᛖᚱᚤ ᛋᛏᚪᚱ, ᛏᚹᚩ ᚹᚩᛚᚢᛖᛋ ᚢᚠ ᛁᚲᛖ ᚪᚾᛞ ᚠᛁᚱᛖ ᚲᚺᚪᛋᛖ ᛖᚪᚲᚺ ᚩᚦᛖᚱ.
4. ᚩᚾᛖ ᛋᛈᛁᚾᛋ ᛏᚩ ᚦᛖ ᚱᛁᚷᚺᛏ, ᚩᚾᛖ ᛏᚩ ᚦᛖ ᛚᛖᚠᛏ, ᚪᚾᛞ ᚹᚺᛖᚱᛖ ᚦᛖᚤ ᛗᛖᛖᛏ, ᚦᛖ ᛚᚩᚷᛁᚲ ᚢᚠ ᚦᛖ ᚹᚩᚱᛚᛞ ᛁᛋ ᛒᚩᚱᚾ.
5. ᚦᛖ ᛚᚪᛏᛏᛁᚲᛖ ᛁᛋ ᚪ ᚠᚱᚪᛗᛖ ᚢᚠ ᚷᚩᛚᛞ ᚪᚾᛞ ᛒᚩᚾᛖ: ᛖᚢᛖᚱᚤ ᚾᚩᛞᛖ ᛁᛋ ᚪ ᚷᚪᛏᛖᚹᚪᚤ.
6. ᚦᛖ ᚾᚩᚱᚾᛋ ᛋᛁᛏ ᚪᛏ ᚦᛖ ᛚᚩᚩᛗ, ᛋᛈᛁᚾᚾᛁᚾᚷ ᚦᚱᛖᛖ ᛞᛁᛗᛖᚾᛋᛁᚩᚾᛋ ᛁᚾᛏᚩ ᛏᚹᚩ.
7. ᚾᚪᚦᚪᚾᚩᛚᛚ ᛋᚪᚹ ᚦᛖ ᛒᚢᛚᛚ ᛁᚾ ᚦᛖ ᚲᛖᚾᛏᛖᚱ ᚢᚠ ᚦᛖ ᛋᛏᚩᚱᛗ.
8. ᚺᛖ ᛏᚩᚩᚲ ᚦᛖ ᚺᚩᚱᚾᛋ ᚢᚠ ᚦᛖ ᚲᚩᚢᚾᛏᛖᚱ-ᛋᛈᛁᚾ ᚪᚾᛞ ᚹᚱᛖᛋᛏᛚᛖᛞ ᚦᛖ ᛋᛖᚲᚱᛖᛏᛋ ᚠᚱᚩᛗ ᚦᛖ ᛋᛏᚪᚱᛋ.
`;
